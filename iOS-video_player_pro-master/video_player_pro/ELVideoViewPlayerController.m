...
- (id) initWithContentPath:(NSString *)path
    ...
    if (self) {
        _playerViewController = [VideoPlayerViewController viewControllerWithContentPath:path contentFrame:frame usingHWCodec:usingHWCodec playerStateDelegate:self parameters:parameters];
